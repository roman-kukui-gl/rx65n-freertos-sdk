...
void uart_charput(unsigned char output_int);	//TODO Fix wrapper function arguments to char
unsigned char uart_charget (void);			//TODO Fix wrapper function return value to char
